...
export const Icon = ({ iconName, ...props }: IIconProps) => {
  return (
    <div
      {...props}
      className={twMerge(
        `rounded-full fle shadow-shadow-black ${props.className}`,
