...
export type HttpPostParams = {
  url: string
  // caso queira passar um body(um objeto de qualquer coisa) ou header, tokens de acesso, body: email e senha, etc... outros params alem da url(obrigatoria) para o post,  e nem sempre o body e nem o header vai ser obrigatórios, então colocamos como opcional
  body?: object
}
